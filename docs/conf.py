...
extlinks = {
    ...
    'rax-dev': ('https://docs.rackspace.com/%s', ''),
    'rax-devdocs': ('https://docs.rackspace.com/docs/%s', ''),
    'rax-devguide': ('https:/docs.rackspace.com/docs/%s', ''),
    'rax-api':
    ('https:/docs.rackspace.com/docs/%s/api-reference', ''),
    'rax-git': ('https://github.com/rackspace/%s', ''),
    'rax-glossary': ('https://docs.rackspace.com/docs/glossary/%s', ''),
...
htmlhelp_basename = 'Rackspace Technology Service Blocks'
